...
export function CTA() {
  return (
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 my-2">
      <div className="relative isolate overflow-hidden  px-6 py-20 text-center sm:rounded-3xl sm:border  sm:px-16 sm:shadow-sm">
        <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight  sm:text-4xl">
          Start using SolerroScheduler Now!
        </h2>
        <h3 className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
          SolerroScheduler makes it easy for your clients to scheduale a meeting with
          you clients.
        </h3>
